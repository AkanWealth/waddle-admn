...
export default function StatusFilterModal({
  ...
  return (
    <div className="absolute  right-0 z-50 top-10 flex items-center justify-center">
      <div className="bg-white rounded-xl shadow-md w-[280px] space-y-4 py-3">
        <div className="">
          {statusOptions.map((status) => (
            <label
              key={status}
              className={`flex items-center space-x-2 text-sm text-gray-700 ${0} border-b border-[#E5E5E5] px-4 py-3`}
            >
              <input
                type="checkbox"
