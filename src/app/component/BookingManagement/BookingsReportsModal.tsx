...
//   // Default date label to last 3 months, formatted as "Mon D - Mon D"
...
//   // Build chart series from filtered vendorsBookingData: monthly revenue for Completed bookings
//   const chartData = (() => {
...
//         return { month: monthLabel(date), revenue };
//       });
//   })();
