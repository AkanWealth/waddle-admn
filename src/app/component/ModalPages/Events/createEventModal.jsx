      ...
      {activeTab === "images" && (
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <textarea
              rows="3"
              placeholder="Add key highlights or special features of your event"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#2853A6] focus:border-[#2853A6]"
            ></textarea>
          </div>
          {/* Upload Photo/Flyer */}
...
<div>
        ...
        <div className="flex items-center gap-6 mt-2">
          ...
          <div>
            ...
            <textarea
              rows="3"
              placeholder="List any items participants should bring (e.g., water bottle, comfortable shoes, etc.)"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#2853A6] focus:border-[#2853A6]"
            ></textarea>
          </div>
