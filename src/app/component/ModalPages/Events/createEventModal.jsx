...
const EventCreationModal = ({ isOpen, onClose, onSave }) => {
  ...
  const [eventFee, setEventFee] = useState('');
    ...
    const selectedCategory = categories.find(cat => cat.value === eventData.category);
    const selectedCapacity = capacityOptions.find(cap => cap.value === eventData.capacity);
    const selectedFrequency = frequencyOptions.find(freq => freq.value === eventData.frequency);
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col gap-4 md:flex-row">
                    ...
                    <div className="flex-1 relative">
                        ...
                        <div className="relative">
                            ...
                            />
                            <svg xmlns="http://www.w3.org/2000/svg" className="absolute left-3 top-2.5 text-gray-400 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            <span className={eventData.time ? 'text-gray-900' : 'text-gray-400'}>
                                ...
                                {timeSlots.map(time => (
                                    <div
                                        ...
                                        className={`px-3 py-2 cursor-pointer hover:bg-gray-50 ${
                                            eventData.time === time ? 'bg-blue-50 text-blue-700' : 'text-gray-900'
                                        }`}
                        ...
                        <div>
                            ...
                            <div className="flex">
                                <div className="relative min-w-22">
                                    ...
                                    >
                                        <span className="text-gray-700">{capacity === 'limited' ? 'Limited' : 'Unlimited'}</span>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="relative">
                        ...
                        >
                            <span className={selectedFrequency?.value ? 'text-gray-900' : 'text-gray-400'}>
                            ...
                            <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg">
                                {frequencyOptions.map(option => (
                                    <div
                                        key={option.value}
                                        className={`px-3 py-2 cursor-pointer hover:bg-gray-50 ${
                                            eventData.frequency === option.value ? 'bg-blue-50 text-blue-700' : 'text-gray-900'
                                        }`}
                            ...
                            <div className="relative h-2">
                                ...
                                <div 
                                    ...
                                    style={{
                                        ...
                                        width: `${((eventData.ageRange.max - eventData.ageRange.min) / 18) * 100}%`
                                    }}
                                ></div>
                                {/* Min thumb */}
                                <div 
                                ...
                                <div 
                                    ...
                                    style={{ 
                                        ...
                                        top: '-4px',
                                        zIndex: eventData.ageRange.max === eventData.ageRange.min ? 20 : 2 // bring to front if overlapping
                                    }}
                                ></div>
                                {/* Min thumb */}
                                <div 
                                    ...
                                    style={{ 
                                        left: `calc(${(eventData.ageRange.min / 18) * 100}% - 8px)`,
                                        top: '-4px',
                                        zIndex: eventData.ageRange.max === eventData.ageRange.min ? 18 : 2 // bring to front if overlapping
                                    }}
                                ></div>
                                {/* Min range input */}
                                <input
                ...
                <div>
                    ...
                    <div className="border border-gray-300 rounded-md px-3 py-2 min-h-10 flex flex-wrap items-center gap-2">
                        ...
                        <input
                            type="text"
                            placeholder={eventData.safetyMeasures.length === 0 ? "Enter applicable event measures" : ""}
                    ...
                    <p className="text-xs text-gray-500 mt-1">Press Enter or Space to add a measure</p>
                </div>
                    ...
                    >
                        {eventData.images.length === 0 ? (
                            <div>
                                ...
                                <p className="text-sm font-medium text-gray-700">Drag and drop your cover image</p>
